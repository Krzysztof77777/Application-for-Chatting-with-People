...
const TermsConditions = () => {
  return (
    <main className="terms">
      ...
      <p>
        Welcome to <b>chat</b> (“Company”, “we”, “our”, “us”)!
      </p>
      <p>
        These Terms of Service (“Terms”, “Terms of Service”) govern your use of
        our website located at <b>heroku.com</b> (together or individually
        “Service”) operated by <b>chat</b>.
      </p>
      <p>
      ...
      <p>
        ...
        <b>chattingbot7@gmail.com</b> so we can try to find a solution. These
      ...
      <p>
        ...
        following the unsubscribe link or by emailing at chattingbot7@gmail.com.
      </p>
      ...
      <p>
        Content found on or through this Service are the property of chat or
      ...
      <p>
        ...
        chat and its licensors. Service is protected by copyright, trademark,
      ...
      <p>
        ...
        to chattingbot7@gmail.com, with the subject line: “Copyright
      ...
      <p>
        You can contact our Copyright Agent via email at chattingbot7@gmail.com.
      </p>
      <p>
        12. <b>Error Reporting and Feedback</b>
      </p>
      <p>
        You may provide us either directly at chattingbot7@gmail.com or via
      ...
      <p>
        ...
        are not owned or controlled by chat.
      </p>
      <p>
        chat has no control over, and assumes no responsibility for the content,
      ...
      <p>
        ...
        of Poland, which governing law applies to agreement without regard to
      ...
      <p>
        ...
        email: <b>chattingbot7@gmail.com</b>.
      </p>
      <p>
        These
        <a href="https://policymaker.io/terms-and-conditions/">
        ...
        were created for <b>heroku.com</b> by
        <a href="https://policymaker.io">PolicyMaker.io</a> on 2021-09-03.
      </p>
    </main>
  );
};
